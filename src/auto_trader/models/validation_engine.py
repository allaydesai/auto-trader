...
class ValidationEngine:
    ...
    def validate_yaml_content(
        self, yaml_content: str, file_path: Optional[Path] = None
    ) -> ValidationResult:
        """
        ...
        return ValidationResult(is_valid=is_valid, errors=errors, plan_id=plan_id)
    ...
    def _validate_single_plan(
        self, plan_data: Dict[str, Any], plan_index: int
    ) -> List[TradePlanValidationError]:
                ...
                for error_detail in e.errors():
                    ...
                    errors.append(
                        TradePlanValidationError(
                            ...
                            field=field_name,
                            suggestion=self._get_field_suggestion(
    ...
    def _validate_execution_functions(
        self,
        plan_data: Dict[str, Any],
        errors: List[TradePlanValidationError],
        plan_index: int,
    ...
    def _get_field_suggestion(
        self, field_name: str, error_detail: Dict[str, Any]
    ) -> str:
