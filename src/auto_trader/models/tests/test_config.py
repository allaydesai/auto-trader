...
class TestSystemConfig:
    ...
    def test_custom_system_config(self) -> None:
...
class TestConfigLoader:
    ...
    def test_load_system_config_from_file(self, temp_config_files) -> None:
    ...
    def test_load_user_preferences_from_file(self, temp_config_files) -> None:
    ...
    def test_validate_configuration_missing_webhook(self) -> None:
    ...
    def test_validate_configuration_account_balance_mismatch(self) -> None:
...
class TestIBKRConfig:
    ...
    def test_default_ibkr_config(self) -> None:
...
class TestTradingConfig:
    ...
    def test_default_trading_config(self) -> None:
    ...
    def test_order_timeout_validation(self) -> None:
