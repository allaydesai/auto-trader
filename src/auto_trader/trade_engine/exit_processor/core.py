...
class ExitProcessor:
    ...
    def __init__(
        ...
        self.order_cancellation_manager = OrderCancellationManager(
    ...
    async def process_exit_signal(
        ...
        try:
            ...
            validation_result = self.validator.validate_exit_signal(
                signal, trade_plan, position
            )
    ...
    async def _process_position_exit(
        ...
        try:
            ...
            cancelled_orders = (
                await self.order_cancellation_manager.cancel_symbol_orders(
            ...
            order_result = await self.exit_order_manager.execute_exit_order(
                exit_order_request
            )
    ...
    async def _process_stop_modification(
        ...
        try:
            ...
            order_result = await self.exit_order_manager.execute_stop_modification(
                stop_order_request
            )
