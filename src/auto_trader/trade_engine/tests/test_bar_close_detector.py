...
async def detector():
    ...
    detector = BarCloseDetector(
        accuracy_ms=500, schedule_advance_ms=100, timezone="America/New_York"
    )
...
class TestBarCloseDetector:
    ...
    async def test_detector_initialization(self):
        ...
        detector = BarCloseDetector(
            accuracy_ms=250, schedule_advance_ms=50, timezone="UTC"
        )
    ...
    def test_calculate_next_close_1min(self, detector):
        ...
        next_close = detector._calculate_next_close(Timeframe.ONE_MIN, base_time)
    ...
    def test_calculate_next_close_daily(self, detector):
        ...
        next_close = detector._calculate_next_close(Timeframe.ONE_DAY, base_time)
