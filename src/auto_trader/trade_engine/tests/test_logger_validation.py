...
class TestLoggerValidationMixin:
    ...
    def test_validate_memory_settings_valid(self):
        ...
        assert (
            LoggerValidationMixin.validate_memory_settings(
                max_memory_entries=1000, max_entries_per_file=500, max_log_files=5
            )
            is True
        )
    ...
    def test_validate_memory_settings_invalid_memory_entries(self):
        ...
        assert (
            LoggerValidationMixin.validate_memory_settings(
                max_memory_entries=0, max_entries_per_file=500, max_log_files=5
            )
            is False
        )
        ...
        assert (
            LoggerValidationMixin.validate_memory_settings(
                max_memory_entries=-1, max_entries_per_file=500, max_log_files=5
            )
            is False
        )
        ...
        assert (
            LoggerValidationMixin.validate_memory_settings(
                max_memory_entries="invalid", max_entries_per_file=500, max_log_files=5
            )
            is False
        )
    ...
    def test_validate_memory_settings_invalid_entries_per_file(self):
        ...
        assert (
            LoggerValidationMixin.validate_memory_settings(
                max_memory_entries=1000, max_entries_per_file=0, max_log_files=5
            )
            is False
        )
    ...
    def test_validate_memory_settings_invalid_log_files(self):
        ...
        assert (
            LoggerValidationMixin.validate_memory_settings(
                max_memory_entries=1000, max_entries_per_file=500, max_log_files=0
            )
            is False
        )
    ...
    def test_validate_file_logging_settings_valid(self):
        ...
        assert (
            LoggerValidationMixin.validate_file_logging_settings(
                enable_file_logging=True, log_dir=Path("/tmp")
            )
            is True
        )
        ...
        assert (
            LoggerValidationMixin.validate_file_logging_settings(
                enable_file_logging=False, log_dir=None
            )
            is True
        )
    ...
    def test_validate_file_logging_settings_enabled_no_dir_warning(self):
        ...
        assert (
            LoggerValidationMixin.validate_file_logging_settings(
                enable_file_logging=True, log_dir=None
            )
            is True
        )
