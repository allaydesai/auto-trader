...
class TestValidateConfigCommand:
    ...
    def test_validate_config_success(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("auto_trader.cli.config_commands.Settings") as mock_settings:
                ...
                mock_settings_instance.discord_webhook_url = (
    ...
    def test_validate_config_with_custom_files(self) -> None:
    ...
    def test_validate_config_verbose(self) -> None:
...
class TestSetupCommand:
    ...
    def test_setup_existing_files_no_force(self) -> None:
    ...
    def test_setup_existing_files_with_force(self) -> None:
