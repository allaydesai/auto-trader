...
class TestWatchUtils:
    ...
    def test_start_file_watching_success(self, tmp_path):
        ...
        with patch(
            "auto_trader.cli.watch_utils.FileWatcher"
        ) as mock_watcher_class, patch(
            "auto_trader.cli.watch_utils.console"
    ...
    def test_validation_callback_created_file(self, tmp_path):
        ...
        with patch(
            ...
            "auto_trader.cli.watch_utils.console"
        ) as mock_console, patch("time.sleep", side_effect=KeyboardInterrupt):
            mock_watcher = Mock()
            mock_watcher.start.return_value = True
            mock_watcher.get_stats.return_value = {
                "events_processed": 1,
            ...
            def capture_callback(*args, **kwargs):
                ...
                captured_callback = (
                    kwargs.get("validation_callback") or args[1]
    ...
    def test_validation_callback_deleted_file(self, tmp_path):
        ...
        with patch(
            ...
            if captured_callback:
                ...
                assert any(
                    "🗑️" in str(call) for call in mock_console.print.call_args_list
                )
