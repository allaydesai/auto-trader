...
class PortfolioTracker:
    ...
    def add_position(
        ...
        logger.info(
            ...
            portfolio_risk_before=float(
                current_risk - (risk_amount / self._account_value * Decimal("100"))
    ...
    def remove_position(self, position_id: str) -> bool:
        ...
        if position_id in self._positions:
            ...
            risk_before = self.get_current_portfolio_risk() + (
                removed.risk_amount / self._account_value * Decimal("100")
                if self._account_value > 0
                else Decimal("0")
            )
            self._persist_state()
    ...
    def get_current_portfolio_risk(self) -> Decimal:
        ...
        total_risk_dollars = sum(
            (pos.risk_amount for pos in self._positions.values()), Decimal("0")
        )
