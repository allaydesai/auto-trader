...
class TestTradePlanValidation:
    ...
    def test_validate_valid_trade_plan(
        ...
        assert (
            result.position_size_result.position_size == 40
        )  # (10000 * 2%) / (180 - 175) = 40
    ...
    def test_validate_portfolio_risk_exceeded(
        ...
        risk_manager.add_position_to_tracking(
            "POS_001", "AAPL", Decimal("400.00"), "AAPL_001"
        )
        risk_manager.add_position_to_tracking(
            "POS_002", "MSFT", Decimal("400.00"), "MSFT_002"
        )
    ...
    def test_validate_with_warnings(
        ...
        assert any(
            "Consider waiting until tomorrow" in warning for warning in result.warnings
        )
...
class TestPortfolioRiskManagement:
    ...
    def test_check_portfolio_risk_limit_within_limit(
        ...
        # Add 5% existing risk
        risk_manager.add_position_to_tracking(
            "POS_001", "AAPL", Decimal("500.00"), "AAPL_001"
        )
    ...
    def test_check_portfolio_risk_limit_exceeded(
        ...
        # Add 8% existing risk
        risk_manager.add_position_to_tracking(
            "POS_001", "AAPL", Decimal("800.00"), "AAPL_001"
        )
    ...
    def test_get_current_portfolio_risk(
        ...
        risk_manager.add_position_to_tracking(
            "POS_001", "AAPL", Decimal("250.00"), "AAPL_001"
        )
    ...
    def test_get_available_risk_capacity(
        ...
        # Add some positions
        risk_manager.add_position_to_tracking(
            "POS_001", "AAPL", Decimal("300.00"), "AAPL_001"
        )
        percent_capacity, dollar_capacity = risk_manager.get_available_risk_capacity()
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_risk_manager_persistence_across_instances(
        ...
        risk_manager1.add_position_to_tracking(
            "POS_001", "AAPL", Decimal("200.00"), "AAPL_001"
        )
