...
from ..risk_models import PortfolioRiskExceededError
...
class TestPositionManagement:
    ...
    def test_add_single_position(self, tracker: PortfolioTracker) -> None:
        ...
        assert tracker.get_current_portfolio_risk() == Decimal(
            "2.00"
        )  # 200/10000 * 100
...
class TestRiskCapacity:
    ...
    def test_available_capacity_empty_portfolio(
    ...
    def test_available_capacity_partial_portfolio(
        self, tracker: PortfolioTracker
    ) -> None:
