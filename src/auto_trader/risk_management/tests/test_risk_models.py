...
class TestPositionSizeResult:
    ...
    def test_valid_position_size_result(
        self, sample_position_size_result: PositionSizeResult
    ) -> None:
    ...
    def test_position_size_result_immutable(
        self, sample_position_size_result: PositionSizeResult
    ) -> None:
...
class TestPositionRiskEntry:
    ...
    def test_valid_position_risk_entry(
        self, sample_position_risk_entry: PositionRiskEntry
    ) -> None:
