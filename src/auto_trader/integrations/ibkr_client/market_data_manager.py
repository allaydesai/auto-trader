...
class MarketDataManager:
    ...
    def __init__(self, ib_client: IB, cache: Optional[MarketDataCache] = None):
        """
        ...
        self._orchestrator = MarketDataOrchestrator(
            self._subscription_manager, self._cache
        )
    ...
    async def subscribe_symbols(
        self, symbols: List[str], bar_sizes: Optional[List[BarSizeType]] = None
    ) -> Dict[str, bool]:
        """
    ...
    def _create_bar_callback(
        self, symbol: str, bar_size: BarSizeType
    ) -> Callable[[any], any]:
        """
    ...
    async def sync_with_active_plans(self, required_symbols: Set[str]) -> None:
        """
    ...
    async def _on_bar_update(
        self, bars: RealTimeBar, symbol: str, bar_size: BarSizeType
    ) -> None:
        """
    ...
    async def cleanup(self) -> None:
        ...
        logger.info("Market data cleanup complete", bars_received=self._bars_received)
