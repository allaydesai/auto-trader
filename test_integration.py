...
async def test_integration():
    ...
    try:
        ...
        client = IBKRClient()
        print("✅ IBKR client created (not connected)")
    ...
    try:
        ...
        webhook = (
            settings.discord_webhook_url or "https://discord.com/api/webhooks/test"
        )
    ...
    try:
        ...
        from auto_trader.trade_engine.trade_orchestrator import TradeOrchestrationConfig

        registry = ExecutionFunctionRegistry()
        print("✅ Execution function registry initialized")
        print(f"   - Registered functions: {len(registry._registry)}")

        # Try to create orchestrator config
        config = TradeOrchestrationConfig()
        print("✅ Trade orchestrator config created")
    ...
    try:
        ...
        print("✅ Trading application initialized")
