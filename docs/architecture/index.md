...
- [Auto-Trader Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    - [TradePlan](./data-models.md#tradeplan)
    - [ExecutionFunction](./data-models.md#executionfunction)
    - [Position](./data-models.md#position)
    - [TradeHistory](./data-models.md#tradehistory)
  - [Components](./components.md)
    - [trade_engine](./components.md#tradeengine)
    - [ibkr_client](./components.md#ibkrclient)
    - [risk_manager](./components.md#riskmanager)
    - [discord_notifier](./components.md#discordnotifier)
    - [state_manager](./components.md#statemanager)
    - [cli_wizard](./components.md#cliwizard)
  ...
  - [Database Schema](./database-schema.md)
    ...
    - [Trade History Schema (CSV)](./database-schema.md#trade-history-schema-csv)
  ...
  - [Checklist Results Report](./checklist-results-report.md)
    ...
    - [Backend-Specific Assessment](./checklist-results-report.md#backend-specific-assessment)
