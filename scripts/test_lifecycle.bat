@echo off
REM Script to run the complete lifecycle integration test on Windows
...
set PYTHONPATH=src
uv run pytest src/auto_trader/trade_engine/tests/test_complete_lifecycle_integration.py -v -s --tb=short
