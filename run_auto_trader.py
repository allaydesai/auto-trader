...
async def check_configuration(settings: Settings) -> bool:
    ...
    try:
        ...
        for dir_path in [settings.plans_directory, settings.state_directory, settings.logs_dir]:
        ...
        if settings.discord_webhook_url and not settings.discord_webhook_url.startswith("https://discord.com/api/webhooks/"):
